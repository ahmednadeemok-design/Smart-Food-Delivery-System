    ...
    <section className="page">
      <div className="container" style={{ maxWidth: 460 }}>
        <form className="card form" onSubmit={mode === "reset" ? submitReset : submit}>
          <img className="auth-brand-logo" src="/brand/rider-icon.svg" alt="SmartFood Rider" />
          <h1>{mode === "forgot" ? "Forgot Password" : mode === "reset" ? "Reset Password" : "Rider Login"}</h1>
          ...
          {mode === "forgot" ? (
            ...
            <>
              ...
              <p className="muted">No rider account? <Link to="/register">Register</Link></p>
            </>
          )}
        </form>
      </div>
