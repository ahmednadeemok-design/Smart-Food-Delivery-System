export const mockAvailableOrders = [
  ...
  {_id:"ORD-NWL-1002", restaurantName:"Buddy's Narowal", customerName:"Mahtab", pickup:"College Road, Narowal", dropoff:"Main Bazaar Narowal", distanceKm:2.4, amount:2200, emergencyMode:false, status:"ready"},
...
export const routeStops = [
  ...
  { id: 2, label: "Pickup: Buddy's Narowal (College Road)", eta: "8 min", type: "pickup" },
