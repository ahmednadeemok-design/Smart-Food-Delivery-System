    ...
    <section className="page">
      <div className="container" style={{ maxWidth: 460 }}>
        <form className="card form" onSubmit={mode === "reset" ? submitReset : submit}>
          <img className="auth-brand-logo" src="/brand/restaurant-partner-logo.svg" alt="SmartFood Restaurant Partner" />
          <h1>{mode === "forgot" ? "Forgot Password" : mode === "reset" ? "Reset Password" : "Restaurant Login"}</h1>
          ...
          {mode === "forgot" ? (
            ...
            <>
              ...
              <p className="muted">No account? <Link to="/register">Register restaurant owner</Link></p>
            </>
          )}
        </form>
      </div>
